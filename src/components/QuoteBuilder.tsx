            ...
            <Card className="mb-8 p-6 bg-white shadow-sm border-2" style={{ borderImage: 'linear-gradient(135deg, #ffb512, #ffde5a, #fea100) 1' }}>
              ...
              {nextDiscount && (
                <div className="mb-6 text-center">
                  <Badge className="bg-green-100 text-green-800 hover:bg-green-100 text-lg px-4 py-2 animate-pulse">
        ...
        {((hasValidSelection && !useUnlimited) || useUnlimited) && (
          <div className="mt-12 border-t-4 border-green-600 pt-8 bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-8">
            ...
            <InclusionsDisplay
              ...
              volumeSavings={selectedStudentData && studentCount >= 12 ? 
        ...
        {((hasValidSelection && !useUnlimited) || useUnlimited) && (
          <div className="mt-8 text-center">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <h3 className="text-lg font-semibold text-green-800 mb-2">📚 Explore Program Materials</h3>
              <p className="text-green-700">Browse all 42 lessons, watch preview videos, and explore textbook samples below</p>
              <ArrowDown className="h-6 w-6 text-green-600 mx-auto mt-2 animate-bounce" />
            </div>
          </div>
        )}
